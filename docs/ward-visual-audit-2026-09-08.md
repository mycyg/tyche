...
| 行动与天赋说明 | 行动格数读取实际规则；“热手”说明为完整查体额外消耗一点体力，费用以本次处置为准，数值说明不触发旁白朗读。 |

现有散步路线为独自活动，不承担搀扶、护送或轮椅转运。儿童、孕期患者及没有明确活动依据的病例保持床旁表现；这不改变接诊、治疗、出院或检定规则。

## 验证证据

- 完整单元与集成测试：139 个文件、2,605 项通过。
...
- 角色短语音为 12 组、每组三句，共 36 句，全部由 RTX 3090 生成并通过逐句转写核对。Chromium 与 WebKit 实际播放全部录音，验证角色内轮换、原句重听和旁白静音；旧全文配音不进入发布包。
