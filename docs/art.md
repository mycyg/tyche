...
| 交互角色 | 六位角色静态与待机图集；地图中五位固定位置角色 | 行走朝向、工作动作；场景移动与交互位置同步 |
| 患者 | 二十种卧床／床旁／画像，加婴儿、儿童、少年和孕妇图集 | 按患者类型检查映射；能下床的患者补坐姿、站立及行走，卧床者保留卧床动作 |
| 家属 | 父母对话画像；没有床旁陪护与走动图集 | 不同年龄与外观的陪护精灵，坐候、床旁照料、走动；录音等剧情动作 |
| 病区生活人物 | 尚无独立背景人流 | 巡床／推车护士、护工、保洁、候诊及送物家属等代表类型 |
