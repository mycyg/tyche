...
export const TERM_GUIDE: { term: string; meaning: string }[] = [
  ...
  { term: "声望", meaning: "科室和外界对你工作的评价。声望参与职业去留和复核阶段的判定，但不能删掉已发生的诊疗问题或伤害。" },
  { term: "关系", meaning: "主任、护士长、同事和家人各有自己的关系值，会影响对应的沟通检定、帮助和后续职业安排。关系好不代表对方已同意签字、作证或交出资料。" },
  { term: "抑郁倾向", meaning: "你长期积累的心理负担。抑郁倾向会减少抗压加成，影响状态上限；长期过高还会影响心理状况和职业去向。它与当下的情绪分开计算。" },
